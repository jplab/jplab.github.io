...
\node[etape,text width=4cm,] (Steuer) [below left=of Bank] {{\large Steuerbefreiung}\\Give your Steuernummer (which does not exist is Canada) and your new Anmeldungbescheinigung (which obviously doesn't exist in Canada)};
